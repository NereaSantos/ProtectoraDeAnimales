                ...
                <table class="tablaAD">
                    <form method="post" action="">
                        ...
                        <tr>
                            ...
                            <td><input class="buscar" type="date" name="fechaI" value=" <?php echo date('Y-m-d'); ?>" />
                            </td>
                    ...
                    <?php foreach ($datos as $row) { ?>
                        ...
                        <td> <select class="buscar" name="animal">
                                <option selected='true' disabled='disabled' value=''>
                                    <?php foreach ($animal->obtieneDeID($row->idAnimal) as $linea)
                                        echo $linea->nombre; ?>
                                </option>
                        ...
                        <td> <select class="buscar" name="usuario">
                                <option selected='true' disabled='disabled' value=''>
                                    <?php foreach ($usuario->obtieneDeID($row->idUsuario) as $linea)
                                        echo $linea->nombre; ?>
                                </option>
                                <?php
                                try {
